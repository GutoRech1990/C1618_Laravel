<x-layout>
    <div class="max-w-2xl mx-auto">
        ...
        <div class="mb-8 text-center">
            <h1 class="text-3xl font-bold text-gray-900">Ajouter un Patient</h1>
            <p class="mt-2 text-sm text-gray-700">Remplissez les informations pour ajouter un nouveau patient</p>
        </div>
        ...
        <div class="bg-white shadow-sm rounded-lg overflow-hidden">
            ...
            <form action="{{ route('patients.store') }}" method="POST" class="p-6 space-y-6">
                ...
                <div>
                    ...
                    <div class="mt-1">
                        {{-- Input avec gestion des erreurs de validation et conservation des données --}}
                ...
                <div>
                    ...
                    <div class="mt-1">
                        {{-- Input texte avec validation et placeholder --}}
                ...
                {{-- Champ pour la date de naissance avec calcul automatique de l'âge --}}
                <div>
                    <label for="birth_date" class="block text-sm font-medium text-gray-700">Date de Naissance</label>
                    <div class="mt-1">
                        {{-- Input de type date qui déclenche le calcul de l'âge --}}
                ...
                {{-- Champ pour l'âge (calculé automatiquement via JavaScript) --}}
                <div>
                    <label for="age" class="block text-sm font-medium text-gray-700">Age</label>
                    <div class="mt-1">
                        {{-- Input numérique mis à jour automatiquement --}}
